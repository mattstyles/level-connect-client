...
var Client = (function (_EventEmitter) {
    ...
    Client.prototype.requestToken = regeneratorRuntime.mark(function requestToken() {
        var res;
        return regeneratorRuntime.wrap(function requestToken$(context$2$0) {
            while (1) switch (context$2$0.prev = context$2$0.next) {
                case 0:
                    res = null;
                    context$2$0.prev = 1;
                ...
                case 4:
                    ...
                    context$2$0.prev = 6;
                    context$2$0.next = 9;
                    return _file2['default'].writeFile(this.tokenFile, res.body.id);

                case 9:
                    return context$2$0.abrupt('return', res.body.id);
